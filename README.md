...
1. **克隆仓库**
```bash
git clone https://github.com/MoKangMedical/MediSlim.git
cd MediSlim
```
...
1. **构建镜像**
```bash
docker build -t MediSlim .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name MediSlim MediSlim
```
...
- **项目主页**: https://github.com/MoKangMedical/MediSlim
- **问题反馈**: https://github.com/MoKangMedical/MediSlim/issues
